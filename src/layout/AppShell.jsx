...
import {
  ...
  LogOut, FileText, ListChecks, Keyboard
} from 'lucide-react'
...
const AppShell = ({ children }) => (
  <div className="min-h-screen w-full text-gray-900 dark:text-gray-100">
    <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-[260px_1fr] gap-4 md:gap-6 p-4 md:p-6">
      <aside
        className="sticky top-4 h-max rounded-2xl border border-gray-200 dark:border-white/10 bg-white/80 dark:bg-white/5 backdrop-blur p-4"
